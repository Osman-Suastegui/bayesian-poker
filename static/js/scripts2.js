function validarUsuario() {
    ...
    if (!usuarioRegex.test(usuario)) {
      usuarioInput.setCustomValidity('El usuario debe contener entre 4 y 16 caracteres, y solo puede contener letras y números');
      usuarioError.textContent = 'El usuario debe contener entre 4 y 16 caracteres, y solo puede contener letras y números';
    } else {
  ...
  function validarConfirmarContrasena() {
    ...
    if (confirmarContrasena !== contrasenaInput.value) {
      confirmarContrasenaInput.setCustomValidity('La contraseña y la confirmación de contraseña no coinciden');
        confirmarContrasenaError.textContent = 'La contraseña y la confirmación de contraseña no coinciden';
    } else {
  ...
  function validarEmail() {
    ...
    if (!emailRegex.test(email)) {
      emailInput.setCustomValidity('Debe ingresar un correo electrónico válido');
